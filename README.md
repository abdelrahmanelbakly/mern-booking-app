...
```bash
git clone https://github.com/abdelrahmanelbakly/mern-booking-app.git
cd mern-booking-app
```
...
This project was created under the guidance of this [YouTube video](https://www.youtube.com/watch?v=YdBy9-0pER4&t=45156s).
